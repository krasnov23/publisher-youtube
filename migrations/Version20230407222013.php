 ...
 */
final class Version20230407222013 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book ALTER publication_data TYPE DATE');
        $this->addSql('COMMENT ON COLUMN book.publication_data IS \'(DC2Type:date_immutable)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book ALTER publication_data TYPE DATE');
        $this->addSql('COMMENT ON COLUMN book.publication_data IS NULL');
    }
}
